...
resource "local_file" "private_key" {
  ...
  filename = "${path.module}/../../../ssh-keys/jenkins-private-key-3.pem"
...
# IAM Role for Jenkins EC2 (ONLY JENKINS-SPECIFIC!)
...
# CORRECTED: Use EKS Describe policy instead of WorkerNodePolicy
